...
var _Exercises_instances, renderFiltersCards_fn, renderFiltersPagination_fn, renderExercisesCards_fn, renderExercisesPagination_fn;
(function polyfill() {
...
class Client {
   ...
   */
  async listFilters({ filter: filter2, page = 1, limit = 10 }) {
  ...
  async getQuoteOfTheDay() {
    const currentDateString = (/* @__PURE__ */ new Date()).toISOString().split("T")[0];
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function setActive(button) {
    homeButton == null ? void 0 : homeButton.classList.remove("active");
    favoritesButton == null ? void 0 : favoritesButton.classList.remove("active");
    button == null ? void 0 : button.classList.add("active");
  }
  function openMobileMenu() {
    mobileMenu == null ? void 0 : mobileMenu.classList.add("is-open");
    backdrop == null ? void 0 : backdrop.classList.remove("is-hidden");
    body.classList.add("no-scroll");
  }
  function closeMobileMenu() {
    mobileMenu == null ? void 0 : mobileMenu.classList.remove("is-open");
    backdrop == null ? void 0 : backdrop.classList.add("is-hidden");
    body.classList.remove("no-scroll");
  }
  homeButton == null ? void 0 : homeButton.addEventListener("click", function(e) {
    e.preventDefault();
    setActive(homeButton);
    window.location.href = "index.html";
  });
  favoritesButton == null ? void 0 : favoritesButton.addEventListener("click", function(e) {
    e.preventDefault();
    setActive(favoritesButton);
    window.location.href = "favorites.html";
  });
  mobileHomeLink == null ? void 0 : mobileHomeLink.addEventListener("click", function(e) {
    e.preventDefault();
    setActive(homeButton);
    closeMobileMenu();
    window.location.href = "index.html";
  });
  mobileFavoritesLink == null ? void 0 : mobileFavoritesLink.addEventListener("click", function(e) {
    e.preventDefault();
    setActive(favoritesButton);
    closeMobileMenu();
    window.location.href = "favorites.html";
  });
  openMenuButton == null ? void 0 : openMenuButton.addEventListener("click", openMobileMenu);
  closeMenuButton == null ? void 0 : closeMenuButton.addEventListener("click", closeMobileMenu);
  backdrop == null ? void 0 : backdrop.addEventListener("click", closeMobileMenu);
...
class Exercises {
   ...
   * */
  constructor(api2, filter2, container, { limit = 10, startCallback } = {}) {
    __privateAdd(this, _Exercises_instances);
    this.api = api2;
    this.filter = filter2;
  ...
  async resetToFilters({ page = 1 } = {}) {
    ...
    __privateMethod(this, _Exercises_instances, renderFiltersCards_fn).call(this, filters);
    __privateMethod(this, _Exercises_instances, renderFiltersPagination_fn).call(this, page, totalPages);
  }
  async resetToExercises({ filter: filter2, keyword, page = 1 } = {}) {
    this.container.innerHTML = "";
    const params = {
      keyword,
      page,
    ...
    switch (this.filter) {
      case FILTERS_BODY_PARTS:
        params.bodypart = filter2;
        break;
      case FILTERS_MUSCLES:
        params.muscles = filter2;
        break;
      case FILTERS_EQUIPMENT:
        params.equipment = filter2;
        break;
    }
    const rs = await this.api.listExercies(params);
    __privateMethod(this, _Exercises_instances, renderExercisesCards_fn).call(this, rs.results);
    __privateMethod(this, _Exercises_instances, renderExercisesPagination_fn).call(this, {
      filter: filter2,
      keyword,
      page,
 ...
 * */
renderFiltersPagination_fn = function(page, totalPages) {
  if (totalPages <= 1) {
    return;
  }
  let first = 1;
  ...
  for (let i = first; i <= last; i++) {
    const item = createPaginationItem({
      content: i,
      isActive: i === page,
      onClick: (page2) => this.resetToFilters({ page: page2 })
    });
    pagination.appendChild(item);
  }
  this.container.appendChild(pagination);
};
renderExercisesCards_fn = function(exercises) {
  const list = document.createElement("ul");
...
renderExercisesPagination_fn = function({ filter: filter2, keyword, page, totalPages }) {
  if (totalPages <= 1) {
    return;
  }
  let first = 1;
  ...
  for (let i = first; i <= last; i++) {
    const item = createPaginationItem({
      content: i,
      isActive: i === page,
      onClick: (page2) => this.resetToExercises({ filter: filter2, keyword, page: page2 })
    });
    pagination.appendChild(item);
  }
  this.container.appendChild(pagination);
